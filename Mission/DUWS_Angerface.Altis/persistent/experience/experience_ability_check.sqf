         ...
         if (!isMultiplayer) then {                                           
          ...
          player createDiaryRecord ["abilities_info", ["Quick Reflexes", "<font color='#FF0000'>Cooldown: 5 minutes</font color><br/>Description:<br/>When activated through the radio menu, the time is slowed down for around 12 seconds, allowing you to clear rooms, compound or kill in a brief amount of tyme a group of enemies."]];
		 };
		 ...
		 waitUntil {sleep 2; experience_total>=30};          
          ...
          player createDiaryRecord ["abilities_info", ["Field Repair", "<font color='#FF0000'>Cooldown: 1 hour</font color><br/>Description:<br/>When activated through the radio menu, the vehicle you are inside will be repaired and some fuel added."]];
