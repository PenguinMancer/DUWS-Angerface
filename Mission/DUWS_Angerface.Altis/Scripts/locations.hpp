class CfgNotifications
{
	...
	class Location_enter
	{
		...
		iconText = ""; // Short text displayed over the icon. Colored by "color", filled by arguments.
		description = "You are entering a zone"; // Brief description displayed as structured text. Colored by "color", filled by arguments.
		color[] = {1,1,1,1}; // Icon and text color
		duration = 5; // How many seconds will the notification be displayed
		priority = 0; // Priority; higher number = more important; tasks in queue are selected by priority
		difficulty[] = {}; // Required difficulty settings. All listed difficulties has to be enabled
	...
	class Location_leave
	{
		...
		iconPicture = "\A3\ui_f\data\map\mapcontrol\tourism_ca.paa"; // Small icon displayed in left part. Colored by "color", filled by arguments.
		iconText = ""; // Short text displayed over the icon. Colored by "color", filled by arguments.
		description = "You are leaving a zone"; // Brief description displayed as structured text. Colored by "color", filled by arguments.
		color[] = {1,1,1,1}; // Icon and text color
		duration = 5; // How many seconds will the notification be displayed
		priority = 0; // Priority; higher number = more important; tasks in queue are selected by priority
		difficulty[] = {}; // Required difficulty settings. All listed difficulties has to be enabled
	...
	class US_lostcontrol
	{
		...
		iconText = ""; // Short text displayed over the icon. Colored by "color", filled by arguments.
		description = "Friendly forces have lost control of %1"; // Brief description displayed as structured text. Colored by "color", filled by arguments.
	...
	{
		title = "Zone recaptured";
		iconText = "+%1";
		description = "There is no CP bonus for recapturing a zone";
		color[] = {0.5,1,1,1};
		priority = 0;
		difficulty[] = {};
	};
	class CPlost
	{
		title = "A zone was lost.";
		iconText = "+%1";
		description = "A zone has been recaptured by the enemy";
		color[] = {1,0,0,1};
		priority = 0;
		difficulty[] = {};
	};
