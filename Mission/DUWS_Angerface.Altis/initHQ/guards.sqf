...
_GuardSoldier3 = [] call Soldiers_fnc_GetBluforLeader;
_GuardSoldier4 = [] call Soldiers_fnc_GetBluforAntiTank;
_GuardSoldier5 = [] call Soldiers_fnc_GetBluforGrenadier;
...
_HQguard3 = _groupGuard createUnit [_GuardSoldier3, _centerPos, [], 0, "FORM"];
...
_HQguard4 = _groupGuard createUnit [_GuardSoldier4, _centerPos, [], 0, "FORM"];
...
_HQguard5 = _groupPatrol createUnit [_GuardSoldier5, _centerPos, [], 0, "FORM"];
