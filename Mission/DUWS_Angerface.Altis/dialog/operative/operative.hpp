...
class operative_recruit_button: RscButton
{
	...
	w = 12 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Add this operative to your squad";
};
...
class operative_aim_txt: RscText
{
	...
	w = 3.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "General accuracy of the operative with weapons";
};
class operative_spot_txt: RscText
{
	...
	w = 4.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "General spotting skill of the operative";
};
class operative_courage_txt: RscText
{
	...
	w = 4.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Morale of the operative";
};
class operative_communications_txt: RscText
{
	...
	w = 8 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Affects how quickly recognized targets are shared with the group";
};
class operative_reflexes_txt: RscText
{
	...
	w = 4.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Affects how quickly the operative can rotate and stabilize its aim";
};
class operative_reload_txt: RscText
{
	...
	w = 6.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "How quickly the operative reload and switch weapons";
};
...
class operative_available_points_txt: RscText
{
	...
	w = 8 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Available points to spend";
};
...
class operative_add_aiming: RscButton
{
	...
	w = 1 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Spend 1 point on this skill";
