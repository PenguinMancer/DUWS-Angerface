...
_index0 = lbAdd [2101, "Sniper Team(8CP)"];                // 5
_index0 = lbAdd [2101, "Medical Team(10CP)"];              // 6
_index0 = lbAdd [2101, "Motorized scouts(28CP)"];          // 7
_index0 = lbAdd [2101, "Mechanized squad(36CP)"];          // 8
_index0 = lbAdd [2101, "Tank Section Slammer(40CP)"];      // 9
_index0 = lbAdd [2101, "Tank Platoon AA(40CP)"];           // 10
lbSetCurSel [2101, 0];