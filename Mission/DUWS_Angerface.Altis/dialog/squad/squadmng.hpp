...
{
	idc = 1600;
	text = "Disband/Delete Yellow Team";
	x = 8 * GUI_GRID_W + GUI_GRID_X;
	y = 13 * GUI_GRID_H + GUI_GRID_Y;
	w = 12 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Disband and delete the squad members under your control";
	action = "_derp = [] execVM 'dialog\squad\dismissDEL.sqf'; closeDialog 0";
};
class dismissbutton: RscButton
{
	idc = 1600;
	text = "Add Yellow Team to High Command";
	x = 21.5 * GUI_GRID_W + GUI_GRID_X;
	y = 13 * GUI_GRID_H + GUI_GRID_Y;
	w = 12 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Add the squad members under your control with High Command";
	action = "_derp = [] execVM 'dialog\squad\dismiss.sqf'; closeDialog 0";
};
class dismiss_txt_info: RscText
{
	idc = 1000;
	text = "To select a squad member, select him(F1-F12) then assign him to team yellow with the radio menu (9-4)";
...
{
	idc = 1001;
	text = "When asked to select a squad, you'll have 10 seconds to select it with the command menu (F1-F12)";
	x = 1 * GUI_GRID_W + GUI_GRID_X;
...
{
	idc = 1601;
	text = "Disband selected HC squad and add the units to your squad";
	x = 12.5 * GUI_GRID_W + GUI_GRID_X;
	y = 19 * GUI_GRID_H + GUI_GRID_Y;
	w = 24.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Dismiss a HC squad and add the units under your direct control";
	action = "_derp = [] execVM 'dialog\squad\dismissHC.sqf'; closeDialog 0";	
};
class renameHC_button: RscButton
{
	idc = 1601;
	text = "Rename a HC squad";
	x = 2 * GUI_GRID_W + GUI_GRID_X;
	y = 19 * GUI_GRID_H + GUI_GRID_Y;
	w = 10 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Rename a HC squad";
...
class leave_button: RscButton
{
	...
	w = 11 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	tooltip = "Exit the squad manager";
