...
if (WARCOM_opfor_ap > 50) then {
	if (WARCOM_opfor_ap > 100) then {
		_initGroup = ["Opfor_Soldier_1","Opfor_Soldier_1","Opfor_Autorifleman_1","Opfor_Grenadier_1","Opfor_Marksman_1","Opfor_Light_AntiTank_1","Opfor_TeamLeader_1"];
	} else {
		_initGroup = ["Opfor_Autorifleman_1","Opfor_Grenadier_1","Opfor_Marksman_1","Opfor_Light_AntiTank_1","Opfor_TeamLeader_1"];
	};
} else{
_initGroup = ["Opfor_Soldier_1","Opfor_Soldier_1","Opfor_Grenadier_1","Opfor_Light_AntiTank_1","Opfor_TeamLeader_1"];
};
