...
/*
_plane1 = createVehicle ["B_UAV_01_F", _centerPos,[], 0, "FLY"];
_plane1 setpos [round(_centerPos select 0) + 50,round(_centerPos select 1) + 50, (_centerPos select 2) + 500];
_planegroup1 = createvehiclecrew _plane1; 

sleep 2;

_wp1 = _planegroup1 addWaypoint [_centerPos,0];
