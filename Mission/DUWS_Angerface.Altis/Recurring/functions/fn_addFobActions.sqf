...
_fob addAction ["<t color='#ff0066'>Heal (2CP)</t>", { [] call Recurring_fnc_heal }, "", 0, true, true, "", "_this == player"];
_fob addaction ["<t color='#ff0066'>SATCOM</t>", {call PXS_startSatellite;}, "", 0, true, true, "", "_this == player;Satellite == 1"];
_fob addaction ["<t color='#15ff00'>HALO Alone (5CP)</t>", "ATM_airdrop\atm_airdrop.sqf", "", 0, true, true, "", "_this == player;Halojump == 1"];
_fob addaction ["<t color='#15ff00'>HALO Group (5CP)</t>", "COB_HALO\grphalo.sqf", "", 0, true, true, "", "_this == player;Halojump == 1"];
...
_fob addaction ["<t color='#00b7ff'>Save</t>",{ [] call Recurring_fnc_restServer }, "", 0, true, true, "", "_this == player1"];