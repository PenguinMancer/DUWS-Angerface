		...
		linkedItems[] = {"SFG_Tac_smallBeardD", "SP_Shemagh_CheckTan", "CUP_V_B_RRV_DA1", Standard_Equipment_Opf}; // Item's added to the unit. 
		respawnLinkedItems[] = {"SFG_Tac_smallBeardD", "SP_Shemagh_CheckTan", "CUP_V_B_RRV_DA1", Standard_Equipment_Opf}; // Item's added to the unit. Should be identical to the linkedItems section.
		...
		class Opfor_SquadLeader_3 : Opfor_SquadLeader_2  {
		scope = 2;
		...
		class Opfor_SquadLeader_4 : Opfor_SquadLeader_1  {
		scope = 2;
		...
		class Opfor_SquadLeader_5 : Opfor_SquadLeader_1  {
		scope = 2;
		...
		class Opfor_SquadLeader_6 : Opfor_SquadLeader_1  {
		scope = 2;
		...
		class Opfor_SquadLeader_7 : Opfor_SquadLeader_1  {
		scope = 2;
		...
		class Opfor_SquadLeader_8 : Opfor_SquadLeader_7  {
		scope = 2;
		...
		class Opfor_SquadLeader_9 : Opfor_SquadLeader_1  {
		scope = 2;
		...
		class Opfor_SquadLeader_10 : Opfor_SquadLeader_1  {
		scope = 2;
