		...
		linkedItems[] = {"lbt_medical_mc", "CUP_H_USMC_LWH_DES", "LBG_Shemagh_Tan", Standard_Equipment_Blu}; // Item's added to the unit. 
		respawnLinkedItems[] = {"lbt_medical_mc", "CUP_H_USMC_LWH_DES", "LBG_Shemagh_Tan", Standard_Equipment_Blu}; // Item's added to the unit. Should be identical to the linkedItems section.
