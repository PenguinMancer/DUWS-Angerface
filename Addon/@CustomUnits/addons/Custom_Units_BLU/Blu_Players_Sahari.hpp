		...
		class Blufor_Penguin_Sahari_1 : B_DUWS_base_F  {
		scope = 2;
		...
		class Blufor_Fox_Sahari_1 : B_DUWS_base_F  {
		scope = 2;
		...
		class Blufor_Wolf_Sahari_1 : B_DUWS_base_F  {
		scope = 2;
		...
		class Blufor_Crow_Sahari_1 : B_DUWS_base_F  {
		scope = 2;
